...
- Supports WebP, JPEG and JXL compression
...
- **Option 1: Use prebuilt image**
  ...
  services:
    bandwidth-hero-proxy:
      ...
      #   BHP_IGNORE_SIZE_CHECK: false
      #   BHP_TARGET_FORMAT: "" # Available formats: "webp", "jpeg", "jxl"
      #   BHP_AUTO_REDUCE_QUALITY: false
      #   BHP_AUTO_SELECT_FORMAT: true
      #   BHP_AUTO_SELECT_FORMAT_LIST: ["jxl", "webp", "jpeg"]
      #   BHP_PASSTHROUGH_ANIMATED: false
...
| `BHP_IGNORE_SIZE_CHECK`             | `false`                   | Always use result, even if it is larger than the input                         |
| `BHP_TARGET_FORMAT`                 | `""`                      | Target format to use for compression (available: "webp", "jpeg", "jxl")        |
| `BHP_AUTO_REDUCE_QUALITY`           | `false`                   | Automatically retry at a lower quality if the output is larger than the input  |
| `BHP_AUTO_SELECT_FORMAT`            | `false`                   | Automatically compress to all candidate formats and return the smallest result |
| `BHP_AUTO_SELECT_FORMAT_LIST`       | `["jxl", "webp", "jpeg"]` | Candidate formats to test when `BHP_AUTO_SELECT_FORMAT` is enabled             |
| `BHP_PASSTHROUGH_ANIMATED`          | `false`                   | Skip compression for animated images and return the original bytes as-is       |
